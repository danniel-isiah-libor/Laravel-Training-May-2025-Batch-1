<x-layout>
    ...
    <div class="mx-auto max-w-2xl text-center">
        <h2 class="text-4xl font-semibold tracking-tight text-balance text-gray-900 sm:text-5xl">Register Pls! Damn</h2>
        <p class="mt-2 text-lg/8 text-gray-600">Aute magna irure deserunt veniam aliqua magna enim voluptate.</p>
    </div>
    <form action="{{ route('register.store')}}" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
        @csrf
        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
            <div>
                <x-forms.field label="Name" name="name" /> <br>
            </div>
            <div>
            ...
            <div class="sm:col-span-2">
                <x-forms.field label="Confirm Password" name="password_confirmation" type="password"/> <br>
            </div>
        </div>
        <div class="mt-10">
