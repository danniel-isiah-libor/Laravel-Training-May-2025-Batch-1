<x-layout>
    ...
    <div class="mx-auto max-w-2xl text-center">
        <h2 class="text-4xl font-semibold tracking-tight text-balance text-gray-900 sm:text-5xl">Company Employee Registration</h2>
        <p class="mt-2 text-lg/8 text-gray-600">OMG KA.</p>
    </div>
    <form action="{{ route('addEmployee') }}" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
        @csrf
        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
        <div class="sm:col-span-2">
            <x-forms.field label="Company Name" name="company_name" type="text"/> <br>
        </div>
        <div class="sm:col-span-2">
            <x-forms.field label="Tenure" name="tenure" type="number"/> <br>
        </div>
        <div class="sm:col-span-2">
            <x-forms.field label="Role" name="role" type="text"/> <br>
        </div>
        </div>
        <div class="mt-10">
