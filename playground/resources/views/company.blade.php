...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-gray-900">New Work Experience</h2>
  </div>
  ...
  <p class="mt-10 text-center text-sm/6 text-gray-500">
      Return to Work Experience Masterfile?
  <a href="{{ route('workexperience.show') }}" class="font-semibold text-indigo-600 hover:text-indigo-500">Click here</a>
  </p>
</div>
</x-layout>
