...
class WorkExperienceController extends Controller
{
    ...
    public function show (WorkExperience $id){
       // $model = WorkExperience::with['user']->where('id',$id->id)->first();


       // $model = WorkExperience::with['work_experiences']->where('id',2)->first();
        //  $model = WorkExperience::where('id',2)
        //  //->join('users','users.id', '=', 'work_experiences.user_id');
        // ->first();
        // dd($model->toArray);
        
        return view ('work-experience.show',['model' => $id]);
    }
    ...
    public function getList()
    {
        ...
        return view('work_experience.index',['models'=>$models]);
    }
